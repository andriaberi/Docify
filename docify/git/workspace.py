...
DEFAULT_WORK_DIR = Path(os.getenv("DOCIFY_WORK_DIR", ".work")).resolve()
...
def clone_repo(url: str, work_dir: Path = DEFAULT_WORK_DIR) -> Path:
    """
...
def cleanup(dest: Path, allowed_root: Path = DEFAULT_WORK_DIR) -> None:
    """
